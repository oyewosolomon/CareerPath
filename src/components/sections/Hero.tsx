      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 sm:pt-24 sm:pb-20">
        <div className="text-center">
          ...
          <div className="mt-10 flex gap-4 justify-center">
            <button className="rounded-md bg-indigo-600 px-6 py-3 text-base font-semibold text-white shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 transition-all duration-200 flex items-center gap-2">
              Get Started Free
              <ArrowRight className="w-4 h-4" />
            </button>
            
            <button className="rounded-md bg-white px-6 py-3 text-base font-semibold text-indigo-600 shadow-sm ring-1 ring-inset ring-indigo-200 hover:bg-gray-50 transition-all duration-200">
              Watch Demo
            </button>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-3">
            ...
            <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-sm ring-1 ring-gray-200">
              <Building className="w-8 h-8 text-indigo-600 mb-2" />
